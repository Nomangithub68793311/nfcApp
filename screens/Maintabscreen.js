...
function DrawerContent(props) {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#FFFFFF', elevation: 10 }}>
            ...
            <DrawerContentScrollView {...props}>
                <Drawer.Section >
                    <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                        <Image source={require('../images/widelogo.png')} style={{
                            width: 160, marginVertical: 20, resizeMode: 'stretch', alignSelf: 'center',
                            height: 35
                        }} />
                    </View>
                ...
                <Drawer.Section style={{ marginTop: -8 }}>
                    ...
                    <DrawerItem style={{
                        backgroundColor: 'white', borderTopColor: '#E7E6E6',
                        borderTopWidth: 1
                    }}
                        icon={({ color, size }) => (
                            <Icon
        ...
        borderTopWidth: 1}}
            ...
            <Drawer.Section style={styles.bottomDrawerSection}>
                <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                    <Image source={require('../images/swopp.png')} style={{
                        width: 165, resizeMode: 'stretch', alignSelf: 'center',
                        height: 30
                    }} />
                </View>
