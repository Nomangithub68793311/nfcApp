  ...
  return (<>
    <Drawer.Navigator drawerContent={(props) => <DrawerContent {...props} />} drawerStyle={{
      ...
      <Drawer.Screen name="Editprofile" options={{
        headerShown: true, title: 'Edit Your Profile',
        headerLeft: () => (
          <IconMAT name="arrow-left" size={30} style={{ marginLeft: 10 }}
            onPress={() =>
              navigation.navigate('ProfileScreen')} />
      ...
      <Drawer.Screen name="Buyswop" options={{
        headerShown: true, title: 'Buy a SWOP',
        headerLeft: () => (
          <IconMAT name="arrow-left" size={30} style={{ marginLeft: 10 }}
            onPress={() =>
              navigation.navigate('ProfileScreen')} />
      ...
      <Drawer.Screen name="Referral" options={{
        headerShown: true, title: 'Referral', headerTitleAlign: 'center',
        headerLeft: () => (
          <IconMAT name="arrow-left" size={30} style={{ marginLeft: 10 }}
            onPress={() =>
              navigation.navigate('ProfileScreen')} />
          ...
          <NavigationContainer >
            <Mainstack.Navigator
              ...
              <Mainstack.Screen name="Accountpage"
                ...
                options={{
                  headerShown: true,
                  title: <Image source={require('./images/widelogo.png')} style={{
                    width: 90, resizeMode: 'stretch', alignSelf: 'center',
                    height: 17
                  }} />,
              ...
              <Mainstack.Screen name="Dashboard" options={{
                headerShown: true,
                title: 'Dashboard',
                headerTitleAlign: 'center',
                headerTitleStyle: {
              ...
              <Mainstack.Screen name="Account2" options={{
              ...
              <Mainstack.Screen name="Privacy"
                ...
                component={Privacy} />
              <Mainstack.Screen name="Terms" options={{
                headerShown: true, headerTitleAlign: 'center',
